...
base_path = "/allen/aibs/mat/tmchartrand/bmtk_networks/singlecell/round4_stage1/Ih"
...
for cell_id in cells_list[:]:
    ...
    # for ih_factor in ih_list:
    #     dynamics_params = {}
    #     node_dict.update(dynamics_params=dynamics_params)
    #     sc.build_epsp_batch(cell_id, path, sm=sm,
    #                       inh=inh, n_duplicates=n_duplicates, overwrite=overwrite, edge_dict=edge_dict, node_dict=node_dict)
