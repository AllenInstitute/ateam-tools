...
cells_df = asdk.get_cells_ephys_df()
rheo = cells_df['threshold_i_long_square']
...
sim_path = networks_path + "singlecell/rheo_me/{}/config.json"
...
cell_id_list = [529878215, 529878215, 548457754, 508279351]
